...
}`;function d(o,r){const n=navigator.gpu.getPreferredCanvasFormat();o.configure({device:r,format:n,alphaMode:"opaque"});const i=r.createRenderPipeline({layout:"auto",vertex:{module:r.createShaderModule({code:u}),entryPoint:"main"},fragment:{module:r.createShaderModule({code:l}),entryPoint:"main",targets:[{format:n}]},primitive:{topology:"triangle-list"}});function e(){const t=r.createCommandEncoder(),c={colorAttachments:[{view:o.getCurrentTexture().createView(),clearValue:{r:.1,g:.3,b:.3,a:1},loadOp:"clear",storeOp:"store"}]},a=t.beginRenderPass(c);a.setPipeline(i),a.draw(6,1,0,0),a.end(),r.queue.submit([t.finish()]),requestAnimationFrame(e)}requestAnimationFrame(e)}function f(o,r){if(!o)throw new Error(r)}(async()=>{if(navigator.gpu===void 0){const t=document.querySelector("#title");t.innerText="WebGPU is not supported in this browser.";return}const o=await navigator.gpu.requestAdapter();if(o===null){const t=document.querySelector("#title");t.innerText="No adapter is available for WebGPU.";return}const r=await o.requestDevice(),n=document.querySelector("#webgpu-canvas");f(n!==null),new ResizeObserver(()=>{n.width=n.clientWidth,n.height=n.clientHeight}).observe(n);const e=n.getContext("webgpu");d(e,r)})();
