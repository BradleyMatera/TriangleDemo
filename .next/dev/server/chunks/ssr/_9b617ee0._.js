...
function createDemoInstance({ id, device, format }) {
    if (id === "two-cubes") {
        return createTwoCubesDemo(device, format);
    }
    return createHelloTriangleDemo(device, format);
}
function createHelloTriangleDemo(device, format) {
    // Based on the official Hello Triangle sample:
...
function createTwoCubesDemo(device, format) {
    // Based on the official Two Cubes sample:
    ...
    device.queue.writeBuffer(vertexBuffer, 0, cubeVertexData.buffer, cubeVertexData.byteOffset, cubeVertexData.byteLength);
    const shaderModule = device.createShaderModule({
        code: /* wgsl */ `
      struct Uniforms {
    ...
    const modelMatrix0 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].create();
    const modelMatrix1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].create();
    const mvpMatrix0 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].create();
    const mvpMatrix1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].create();
    const uniformData0 = new Float32Array(16);
    const uniformData1 = new Float32Array(16);
    let aspect = 1;
    ...
    return {
        ...
        update: (timestamp)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].identity(modelMatrix0);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].translate(modelMatrix0, modelMatrix0, [
                -1.8,
                0,
                0
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].rotate(modelMatrix0, modelMatrix0, rotation * 0.7, [
                0,
                1,
                0
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].rotate(modelMatrix0, modelMatrix0, rotation * 0.4, [
                1,
                0,
                0
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].multiply(mvpMatrix0, viewProjectionMatrix, modelMatrix0);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].identity(modelMatrix1);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].translate(modelMatrix1, modelMatrix1, [
                1.8,
                0,
                0
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].rotate(modelMatrix1, modelMatrix1, rotation, [
                0,
                1,
                0
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].rotate(modelMatrix1, modelMatrix1, rotation * 0.6, [
                0,
                0,
                1
            ]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gl$2d$matrix$2f$esm$2f$mat4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__mat4$3e$__["mat4"].multiply(mvpMatrix1, viewProjectionMatrix, modelMatrix1);
            uniformData0.set(mvpMatrix0);
            uniformData1.set(mvpMatrix1);
            device.queue.writeBuffer(uniformBuffer, 0, uniformData0);
            device.queue.writeBuffer(uniformBuffer, uniformStride, uniformData1);
        },
        render: (pass)=>{
            pass.setPipeline(pipeline);
            pass.setVertexBuffer(0, vertexBuffer);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const run = async ()=>{
            ...
            if (result.status === "ready") {
                ...
                result.setShape(shapeRef.current);
                setState({
                    status: "ready"
                });
            } else {
...
//# sourceMappingURL=_9b617ee0._.js.map